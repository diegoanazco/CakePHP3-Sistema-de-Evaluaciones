...
class SectionsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setDisplayField('sections_groups');
        $this->setPrimaryKey('sections_id');
    ...
    public function validationDefault(Validator $validator)
    {
        $validator
            ->integer('sections_id')
            ->allowEmptyString('sections_id', null, 'create');

        $validator
            ->scalar('sections_groups')
            ->maxLength('sections_groups', 10)
            ->requirePresence('sections_groups', 'create')
            ->notEmptyString('sections_groups');
