...
class DepartmentsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setDisplayField('departments_name');
    ...
    public function validationDefault(Validator $validator)
    {
        $validator
            ...
            ->allowEmptyString('departments_id', null, 'create');

        $validator
            ->scalar('departments_name')
            ->maxLength('departments_name', 150)
            ->requirePresence('departments_name', 'create')
            ->notEmptyString('departments_name');
