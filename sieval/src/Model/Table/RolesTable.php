...
class RolesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('roles');
        $this->setDisplayField('roles_description');
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('roles_description')
            ->maxLength('roles_description', 150)
            ->requirePresence('roles_description', 'create')
            ->notEmptyString('roles_description');
